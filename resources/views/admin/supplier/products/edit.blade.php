        ...
        <div class="container-md">
          <div class="card mb-3 mt-2">
            <div class="card-body d-flex justify-content-between align-items-center">
              <h5 class="mb-0">Edit Supplier Product — Supplier: {{ $supplier->supplier_name ?? '—' }}</h5>
          ...
          <div class="card">
            <div class="card-body">
              <form action="{{ route('suppliers.products.update', $product->id) }}" method="POST" novalidate>
                @csrf
                ...
                <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <input
                      ...
                      value="{{ old('default_cost_price', $product->default_cost_price) }}"
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    >
                      ...
                      @foreach($systemProducts as $p)
                        <option value="{{ $p->id }}" {{ (string) old('linked_product_id', $product->linked_product_id) === (string) $p->id ? 'selected' : '' }}>
                          {{ $p->product_name }}
                        </option>
                      @endforeach
                    </select>

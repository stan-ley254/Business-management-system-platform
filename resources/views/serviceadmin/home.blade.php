  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Point of Service</span>
      </a>
    </div>
...
<!-- Dashboard -->
  ...
  <!-- Clients Dropdown -->
  <li class="nav-item">
    <a data-bs-toggle="collapse" href="#clientsMenu" class="nav-link" aria-controls="clientsMenu" role="button" aria-expanded="false">
      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="collapse" id="clientsMenu">
      <ul class="nav ms-4 ps-3 flex-column">
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="">
            ...
            <span class="sidenav-normal"> View Clients </span>
          </a>
        </li>
      </ul>
    </div>
  ...
  <li class="nav-item">
    <a class="nav-link" href="">
      ...
      <span class="nav-link-text ms-1">Mpesa Settings</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" href="">
      ...
      <span class="nav-link-text ms-1">Smart Assistant</span>
    </a>
  </li>
  ...
  <!-- Services Dropdown -->
  <li class="nav-item">
    <a data-bs-toggle="collapse" href="#servicesMenu" class="nav-link" aria-controls="servicesMenu" role="button" aria-expanded="false">
      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="fas fa-tools text-dark"></i>
      </div>
      <span class="nav-link-text ms-1">Services</span>
    ...
    <div class="collapse" id="servicesMenu">
      <ul class="nav ms-4 ps-3 flex-column">
        <li class="nav-item">
          <a class="nav-link" href="">
            <span class="sidenav-mini-icon"> A </span>
            <span class="sidenav-normal"> Add Service </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Total Clients</span>
                    </div>
                    <div class="col-4">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Today's Revenue</span>
                    </div>
                    <div class="col-4">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Session Logged</span>
                    </div>
                    <div class="col-4">
                      <div class="dropdown text-end mb-6">
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">Total Services</span>
                    </div>
                    <div class="col-4">
                      <div class="dropstart text-end mb-6">
